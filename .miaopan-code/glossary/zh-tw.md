...
- PR #13942: https://github.com/miaopan607/miaopan-code/pull/13942

## Do Not Translate (Locale Additions)

- `miaopan-code` (preserve casing in prose; keep `miaopan-code` only when it is part of commands, package names, paths, or code)
- `miaopan-code Zen`
- `miaopan-code CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `miaopan-code` in prose when referring to the product name; use `miaopan-code`
