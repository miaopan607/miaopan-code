...
- PR #15835: https://github.com/miaopan607/miaopan-code/pull/15835

## Do Not Translate (Locale Additions)

- `miaopan-code` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `miaopan-code` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `miaopan-code` in prose, `miaopan-code` only for exact technical identifiers
...
- Avoid changing `miaopan-code` to `miaopan-code` inside commands, URLs, package names, or code literals
