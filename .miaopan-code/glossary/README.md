...
Use this folder for locale-specific translation guidance that supplements `.miaopan-code/agent/translator.md`.
...
- PR #12345: https://github.com/miaopan607/miaopan-code/pull/12345

## Do Not Translate (Locale Additions)

- `miaopan-code` (preserve casing)
