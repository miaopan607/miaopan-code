...
- PR #10018: https://github.com/miaopan607/miaopan-code/pull/10018
- PR #12935: https://github.com/miaopan607/miaopan-code/pull/12935

## Do Not Translate (Locale Additions)

- `miaopan-code` (preserve casing in prose; keep `miaopan-code` only in commands, package names, paths, or code)
- `miaopan-code CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
