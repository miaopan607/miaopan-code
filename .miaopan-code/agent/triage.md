...
mode: primary
hidden: true
model: miaopan-code/gpt-5.4-mini
color: "#44BA81"
tools:
  "*": false
  "github-triage": true
...
Desktop application and browser-based app issues, including `miaopan-code web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core miaopan-code server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

miaopan-code Zen, miaopan-code Go, and billing issues.
