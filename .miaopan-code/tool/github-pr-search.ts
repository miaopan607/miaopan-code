...
This tool searches PRs in the miaopan607/miaopan-code repository and returns LLM-friendly results including:
- PR number and title
- Author
...
Use the query parameter to search for keywords that might appear in PR titles or descriptions.`,
  ...
  async execute(args) {
    const owner = "miaopan607"
    const repo = "miaopan-code"
