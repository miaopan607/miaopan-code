...
let
  packageJson = lib.pipe ../packages/miaopan-code/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
...
stdenvNoCC.mkDerivation {
  pname = "miaopan-code-node_modules";
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.intersection (lib.fileset.fromSource (lib.sources.cleanSource ../.)) (
      lib.fileset.unions [
        ...
        ../.github/TEAM_MEMBERS # required by @miaopan-code/script
      ]
    );
  };
