...
import { McpEvent } from "@miaopan-code/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/miaopan607/miaopan-code/issues/11948
    // sampling: {},
    // https://github.com/miaopan607/miaopan-code/issues/23066
    // elicitation: {},
    // https://github.com/miaopan607/miaopan-code/issues/2308
    roots: {},
    // https://github.com/miaopan607/miaopan-code/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "miaopan-code", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/MCP") {}
