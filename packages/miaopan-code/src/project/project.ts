...
import { ProjectDirectoryTable, ProjectTable } from "@miaopan-code/core/project/sql"
import { ProjectDirectories } from "@miaopan-code/core/project/directories"
...
import { which } from "@miaopan-code/core/util/which"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.MIAOPAN_CODE_FAKE_VCS)
