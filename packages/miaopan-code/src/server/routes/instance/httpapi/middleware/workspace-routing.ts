...
>()("@miaopan-code/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@miaopan-code/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.MIAOPAN_CODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.MIAOPAN_CODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-miaopancode-directory"] || process.cwd()
}
