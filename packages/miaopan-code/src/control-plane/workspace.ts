...
import { EventSequenceTable, EventTable } from "@miaopan-code/core/event/sql"
...
import { WorkspaceEvent } from "@miaopan-code/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MIAOPAN_CODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MIAOPAN_CODE_WORKSPACE_ID: config.id,
        MIAOPAN_CODE_EXPERIMENTAL_WORKSPACES: "true",
