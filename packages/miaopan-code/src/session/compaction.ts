...
import { buildPrompt } from "@miaopan-code/core/session/compaction"
import { SessionCompactionEvent } from "@miaopan-code/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/SessionCompaction") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const processCompaction = Effect.fn("SessionCompaction.process")(function* (input: {
      ...
      const configured =
        cfg.provider?.[userMessage.model.providerID]?.models?.[userMessage.model.modelID]?.compaction_model
