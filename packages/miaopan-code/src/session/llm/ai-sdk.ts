import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@miaopan-code/llm"
...
// Move this extraction into @miaopan-code/llm when Copilot is handled by the native runtime.
