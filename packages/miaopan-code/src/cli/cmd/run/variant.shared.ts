...
//
// The saved variant persists across sessions in ~/.local/state/miaopanCode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@miaopan-code/RunVariant") {}
