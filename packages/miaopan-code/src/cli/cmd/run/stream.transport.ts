...
import type { Event, GlobalEvent, MiaopanCodeClient } from "@miaopan/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@miaopan-code/RunStreamTransport") {}
