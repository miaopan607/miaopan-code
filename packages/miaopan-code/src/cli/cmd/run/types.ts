// Shared type vocabulary for the direct interactive mode (`miaopan-code --mini`).
//
...
type PromptModel = Parameters<MiaopanCodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<MiaopanCodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<MiaopanCodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<MiaopanCodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<MiaopanCodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<MiaopanCodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<MiaopanCodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<MiaopanCodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<MiaopanCodeClient["question"]["reject"]>[0]
