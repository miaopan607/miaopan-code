...
import { win32InstallCtrlCGuard } from "@miaopan-code/tui/terminal-win32"

declare global {
  const MIAOPAN_CODE_WORKER_PATH: string
}
...
async function target() {
  if (typeof MIAOPAN_CODE_WORKER_PATH !== "undefined") return MIAOPAN_CODE_WORKER_PATH
