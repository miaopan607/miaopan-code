...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@miaopan-code/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@miaopan-code/ACPDirectory") {}
