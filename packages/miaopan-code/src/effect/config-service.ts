 ...
 *   "@miaopan-code/ServerAuthConfig",
 *   {
 *     password: Config.string("MIAOPAN_CODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MIAOPAN_CODE_SERVER_USERNAME").pipe(Config.withDefault("miaopan-code")),
 *   },
 * ) {}
 *
