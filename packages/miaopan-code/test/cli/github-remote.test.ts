...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/miaopanCode.git")).toEqual({ owner: "sst", repo: "miaopan-code" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/miaopanCode")).toEqual({ owner: "sst", repo: "miaopan-code" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/miaopanCode.git")).toEqual({ owner: "sst", repo: "miaopan-code" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/miaopanCode")).toEqual({ owner: "sst", repo: "miaopan-code" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/miaopanCode.git")).toEqual({ owner: "sst", repo: "miaopan-code" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/miaopanCode")).toEqual({ owner: "sst", repo: "miaopan-code" })
})
