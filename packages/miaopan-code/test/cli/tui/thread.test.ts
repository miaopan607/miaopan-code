...
describe("tui thread", () => {
  ...
  cliIt.live("rejects mini-only options without --mini", ({ miaopanCode }) =>
    Effect.gen(function* () {
  ...
  cliIt.live("routes attached sessions to mini mode", ({ miaopanCode }) =>
    Effect.gen(function* () {
  ...
  cliIt.live("rejects network options in mini mode", ({ miaopanCode }) =>
    Effect.gen(function* () {
