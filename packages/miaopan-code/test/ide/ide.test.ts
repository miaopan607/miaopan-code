...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MIAOPAN_CODE_CALLER", () => {
    process.env["MIAOPAN_CODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MIAOPAN_CODE_CALLER", () => {
    process.env["MIAOPAN_CODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MIAOPAN_CODE_CALLER", () => {
    process.env["MIAOPAN_CODE_CALLER"] = "unknown"
