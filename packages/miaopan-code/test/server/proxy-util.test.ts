...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips miaopanCode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-miaopanCode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-miaopanCode-directory")).toBeNull()
      expect(result.get("x-miaopanCode-workspace")).toBeNull()
