...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      MIAOPAN_CODE_EXPERIMENTAL_WORKSPACES: Flag.MIAOPAN_CODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.MIAOPAN_CODE_EXPERIMENTAL_WORKSPACES = original.MIAOPAN_CODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
