...
it.instance("plan agent denies edits except .miaopanCode/plans/*", () =>
  Effect.gen(function* () {
    ...
    expect(Permission.evaluate("edit", ".miaopanCode/plans/foo.md", plan!.permission).action).toBe("allow")
  }),
)
