...
- Proposed package: `@miaopan-code/ai`
...
- Secondary audience: miaopan-code and other durable agent runtimes
...
import { LLM } from "@miaopan-code/ai"
import { OpenAI } from "@miaopan-code/ai/providers/openai"
...
```ts
import { Message } from "@miaopan-code/ai"
...
import { LLM, Tool } from "@miaopan-code/ai"
...
miaopan-code and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@miaopan-code/ai/promise"
import { OpenAI } from "@miaopan-code/ai/providers/openai"
...
```ts
import { LLMSchema } from "@miaopan-code/ai/schema"
...
```ts
import { Provider, Protocol } from "@miaopan-code/ai/provider"
...
@miaopan-code/ai/promise
  Promise/AsyncIterable LLM facade

@miaopan-code/ai/schema
  serializable domain schemas

@miaopan-code/ai/provider
  experimental Provider and Protocol authoring APIs

@miaopan-code/ai/providers/openai
@miaopan-code/ai/providers/anthropic
@miaopan-code/ai/providers/google
...
```
...
miaopan-code should migrate to `generateTurn` / `streamTurn`, preserving its durable
