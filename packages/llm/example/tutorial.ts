...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@miaopan-code/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@miaopan-code/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-miaopanCode-tutorial": "1" },
    query: { debug: "1" },
  },
})
