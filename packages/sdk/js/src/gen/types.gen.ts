...
export type Config = {
  ...
  /**
   * Command configuration, see https://github.com/miaopan607/miaopan-code/docs/commands
   */
  command?: {
    [key: string]: {
      template: string;
  ...
  /**
   * Agent configuration, see https://github.com/miaopan607/miaopan-code/docs/agent
   */
  agent?: {
    plan?: AgentConfig;
    build?: AgentConfig;
