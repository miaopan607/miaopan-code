...
import { compile, emitEffectImported, emitPromise, write } from "@miaopan-code/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "MiaopanCodeEventEncoded",
              import: 'import type { MiaopanCodeEventEncoded } from "@miaopan-code/protocol/groups/event"',
            },
          },
        }),
