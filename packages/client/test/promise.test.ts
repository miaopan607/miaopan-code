...
import { isSessionNotFoundError, isUnauthorizedError, MiaopanCode } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = MiaopanCode.make({ baseUrl: "http://localhost:3000" })
