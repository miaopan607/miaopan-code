...
export const makeLocationGroup = (language?: Language) =>
  HttpApiGroup.make("server.location").add(
    HttpApiEndpoint.get("location.get", "/api/location", {
      ...
      .annotateMerge(
        OpenApi.annotations({
          ...
          summary: t(language, "location_get"),
          description: t(language, "location_get_description"),
        }),
      ),
  )

export const LocationGroup = makeLocationGroup()
