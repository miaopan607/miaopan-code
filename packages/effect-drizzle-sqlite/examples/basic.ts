...
class Database extends Context.Service<Database, DatabaseShape>()("@miaopan-code/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@miaopan-code/example/UserStore") {
