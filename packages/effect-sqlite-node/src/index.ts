...
export const TypeId: TypeId = "~@miaopan-code/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@miaopan-code/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@miaopan-code/effect-sqlite-node/NodeSqliteClient")
