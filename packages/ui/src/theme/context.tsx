...
const STORAGE_KEYS = {
  THEME_ID: "miaopanCode-theme-id",
  COLOR_SCHEME: "miaopanCode-color-scheme",
  THEME_CSS_LIGHT: "miaopanCode-theme-css-light",
  THEME_CSS_DARK: "miaopanCode-theme-css-dark",
} as const
