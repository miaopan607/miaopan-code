...
import { IconMiaopanCode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "miaopan-code/session/message-v2"
import type { Message } from "miaopan-code/session/message"
import type { Session } from "miaopan-code/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.miaopanCode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.miaopanCode_name}>
                    <IconMiaopanCode width={16} height={16} />
                  </div>
