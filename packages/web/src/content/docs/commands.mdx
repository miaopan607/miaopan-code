...
Create `.miaopan-code/commands/test.md`:

```md title=".miaopan-code/commands/test.md"
---
...
You can add custom commands through the miaopan-code config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your miaopan-code [config](/docs/config):

```json title="miaopan-code.jsonc" {4-12}
{
...
- Global: `~/.config/miaopan-code/commands/`
- Per-project: `.miaopan-code/commands/`

```markdown title="~/.config/miaopan-code/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".miaopan-code/commands/component.md"
---
...
```md title=".miaopan-code/commands/create-file.md"
---
...
```md title=".miaopan-code/commands/analyze-coverage.md"
---
...
```md title=".miaopan-code/commands/review-changes.md"
---
...
```md title=".miaopan-code/commands/review-component.md"
---
...
miaopan-code includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
