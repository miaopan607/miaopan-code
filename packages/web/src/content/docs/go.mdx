...
miaopan-code Go is a low cost subscription — **$5 for your first month**, then **$10/month** — that gives you reliable access to popular open coding models.

Go works like any other provider in miaopan-code. You subscribe to miaopan-code Go and
...
miaopan-code Go gives you access to these models for **$5 for your first month**, then **$10/month**.

---

## How it works

miaopan-code Go works like any other provider in miaopan-code.

1. You sign in to **<a href={console}>miaopan-code Zen</a>**, subscribe to Go, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `miaopan-code Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through Go.

:::note
Only one member per workspace can subscribe to miaopan-code Go.
:::
...
miaopan-code Go includes the following limits:
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.2           | glm-5.2           | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.1           | glm-5.1           | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.7 Code    | kimi-k2.7-code    | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://github.com/miaopan607/miaopan-code/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3        | minimax-m3        | `https://github.com/miaopan607/miaopan-code/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7      | minimax-m2.7      | `https://github.com/miaopan607/miaopan-code/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://github.com/miaopan607/miaopan-code/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max       | qwen3.7-max       | `https://github.com/miaopan607/miaopan-code/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus      | qwen3.7-plus      | `https://github.com/miaopan607/miaopan-code/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://github.com/miaopan607/miaopan-code/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |

The [model id](/docs/config/#models) in your miaopan-code config
uses the format `miaopan-code-go/<model-id>`. For example, for Kimi K2.7 Code, you would
use `miaopan-code-go/kimi-k2.7-code` in your config.
...
```
https://github.com/miaopan607/miaopan-code/zen/go/v1/models
```
...
4. Have **no lock-in** by allowing you to use any other provider with miaopan-code as well.
