...
export const Terminal = (props: TerminalProps) => {
  ...
  const username = auth?.username ?? "miaopan-code"
      ...
      const connectToken = async () => {
        const result = await client.pty
          .connectToken(
            ...
            {
              throwOnError: false,
              headers: { "x-miaopanCode-ticket": "1" },
            },
          )
          .catch((err: unknown) => {
