...
beforeAll(async () => {
  ...
  mock.module("@miaopan-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@miaopan-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@miaopan-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@miaopan-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
