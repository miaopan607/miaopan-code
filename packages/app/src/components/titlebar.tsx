...
import { Tooltip, TooltipKeybind } from "@miaopan-code/ui/tooltip"
import { useTheme } from "@miaopan-code/ui/theme/context"
import { IconButtonV2 } from "@miaopan-code/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@miaopan-code/ui/v2/icon"
import { KeybindV2 } from "@miaopan-code/ui/v2/keybind-v2"
...
export function useTitlebarRightMount() {
  ...
  onMount(() => setMount(document.getElementById("miaopanCode-titlebar-right")))
  return mount
}
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="miaopanCode-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div class="min-w-0 flex items-center justify-center pointer-events-none">
              <div
                id="miaopanCode-titlebar-center"
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="miaopanCode-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="miaopanCode-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_MIAOPAN_CODE_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_MIAOPAN_CODE_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
