...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "miaopan-code", key: "dialog.provider.miaopanCode.note" },
  { match: (id: string) => id === "miaopanCode-go", key: "dialog.provider.miaopanCodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "miaopan-code" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "miaopan-code" || item.id === "miaopanCode-go"}>
