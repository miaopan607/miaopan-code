...
const GLOBAL_STORAGE = "miaopanCode.global.dat"
const WINDOW_STORAGE = "miaopanCode.window"
const LOCAL_PREFIX = "miaopanCode."
...
function workspaceStorage(dir: string) {
  ...
  return `miaopanCode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `miaopanCode.draft.${head}.${sum}.dat`
}
