...
import { Session } from "@miaopan-code/sdk/v2/client"
...
import { toaster } from "@miaopan-code/ui/toast"
...
import { useTheme, type ColorScheme } from "@miaopan-code/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/miaopan607/miaopan-code/desktop-feedback")}
      renderPanel={() =>
