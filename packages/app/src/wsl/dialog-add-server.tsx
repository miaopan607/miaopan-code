...
import { showToast } from "@miaopan-code/ui/toast"
import { ButtonV2 } from "@miaopan-code/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@miaopan-code/ui/v2/dialog-v2"
import { DividerV2 } from "@miaopan-code/ui/v2/divider-v2"
import { LoaderV2 } from "@miaopan-code/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@miaopan-code/ui/v2/radio-v2"
import { TextInputV2 } from "@miaopan-code/ui/v2/text-input-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-miaopanCode") {
      await run(() => api.installMiaopanCode(distro))
      return
    }
