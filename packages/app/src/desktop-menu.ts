...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "MiaopanCode Documentation", href: "https://github.com/miaopan607/miaopan-code/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/miaopanCode" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/miaopan607/miaopan-code/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/miaopan607/miaopan-code/issues/new?template=bug_report.yml",
      },
    ],
  },
]
