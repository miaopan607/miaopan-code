...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: MiaopanCodeClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: MiaopanCodeClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: MiaopanCodeClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => MiaopanCodeClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, MiaopanCodeClient>()
