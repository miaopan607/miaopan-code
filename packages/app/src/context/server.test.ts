  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://miaopanCode.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://miaopanCode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://miaopanCode.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://miaopanCode.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://miaopanCode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://miaopanCode.example.com"),
      ),
    ).toEqual({
