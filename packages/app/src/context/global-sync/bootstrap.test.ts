...
import type { Config, MiaopanCodeClient, Project, Session } from "@miaopan-code/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@miaopan-code/session-ui/context"
...
describe("bootstrapDirectory", () => {
  test("marks a loading directory partial during bootstrap and complete after success", async () => {
    ...
    await bootstrapDirectory({
      ...
      } as unknown as MiaopanCodeClient,
      store,
      setStore,
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as MiaopanCodeClient
