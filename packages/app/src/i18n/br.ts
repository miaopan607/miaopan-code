export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.miaopanCode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.miaopanCodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Visite ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MiaopanCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em miaopan-code.json",
  ...
  "dialog.server.description": "Trocar para qual servidor MiaopanCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Verificando o MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Verificando o MiaopanCode em {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Atualizando o MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Atualizando o MiaopanCode em {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Atualize o MiaopanCode em {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Atualizar o MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "O MiaopanCode está pronto em {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "O MiaopanCode está pronto.",
  "wsl.onboarding.installMiaopanCodeIn": "Instale o MiaopanCode em {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Instalar o MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o MiaopanCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O MiaopanCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o MiaopanCode novamente.",
  ...
  "toast.update.description": "Uma nova versão do MiaopanCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MiaopanCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (miaopan-code.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MiaopanCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MiaopanCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o MiaopanCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MiaopanCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MiaopanCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MiaopanCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MiaopanCode.",
