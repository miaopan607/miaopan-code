export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.miaopanCode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.miaopanCodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MiaopanCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w miaopan-code.json",
  ...
  "dialog.server.description": "Przełącz serwer MiaopanCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Sprawdzanie MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Sprawdzanie MiaopanCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Aktualizowanie MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Aktualizowanie MiaopanCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Zaktualizuj MiaopanCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Zaktualizuj MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode jest gotowy.",
  "wsl.onboarding.installMiaopanCodeIn": "Zainstaluj MiaopanCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Zainstaluj MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim MiaopanCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz MiaopanCode.",
  ...
  "toast.update.description": "Nowa wersja MiaopanCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MiaopanCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (miaopan-code.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: MiaopanCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer MiaopanCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd MiaopanCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MiaopanCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MiaopanCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MiaopanCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MiaopanCode.",
