export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.miaopanCode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.miaopanCodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.miaopanCodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.miaopanCodeZen.visit.prefix": "Visita ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MiaopanCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en miaopan-code.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de MiaopanCode se conecta esta app.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Comprobando MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Comprobando MiaopanCode en {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Actualizando MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Actualizando MiaopanCode en {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Actualiza MiaopanCode en {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Actualizar MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode está listo en {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode está listo.",
  "wsl.onboarding.installMiaopanCodeIn": "Instala MiaopanCode en {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Instalar MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que MiaopanCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir MiaopanCode.",
  ...
  "toast.update.description": "Una nueva versión de MiaopanCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de MiaopanCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (miaopan-code.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, MiaopanCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MiaopanCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve MiaopanCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MiaopanCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MiaopanCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MiaopanCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MiaopanCode.",
