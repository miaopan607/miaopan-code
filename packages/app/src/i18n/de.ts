...
export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.miaopanCode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.miaopanCodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in MiaopanCode zu nutzen.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.miaopanCodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.miaopanCodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in MiaopanCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in MiaopanCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In miaopan-code.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den MiaopanCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.miaopanCode": "MiaopanCode",
  ...
  "wsl.onboarding.checkingMiaopanCode": "MiaopanCode wird geprüft...",
  "wsl.onboarding.checkingMiaopanCodeIn": "MiaopanCode in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingMiaopanCode": "MiaopanCode wird aktualisiert...",
  "wsl.onboarding.updatingMiaopanCodeIn": "MiaopanCode in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateMiaopanCodeIn": "Aktualisieren Sie MiaopanCode in {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "MiaopanCode aktualisieren",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode ist in {{distro}} bereit.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode ist bereit.",
  "wsl.onboarding.installMiaopanCodeIn": "Installieren Sie MiaopanCode in {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "MiaopanCode installieren",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor MiaopanCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann MiaopanCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von MiaopanCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MiaopanCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (miaopan-code.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MiaopanCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "MiaopanCode Desktop",
  ...
  "settings.desktop.wsl.description": "MiaopanCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MiaopanCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie MiaopanCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MiaopanCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MiaopanCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MiaopanCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von MiaopanCode.",
