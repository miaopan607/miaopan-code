export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.miaopanCode.tagline": "Reliable optimized models",
  "dialog.provider.miaopanCodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MiaopanCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.miaopanCodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.miaopanCodeZen.visit.prefix": "Visit ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MiaopanCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in miaopan-code.json",
  ...
  "dialog.server.description": "Switch which MiaopanCode server this app connects to.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Checking MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Checking MiaopanCode in {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Updating MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Updating MiaopanCode in {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Update MiaopanCode in {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Update MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode is ready in {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode is ready.",
  "wsl.onboarding.installMiaopanCodeIn": "Install MiaopanCode in {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Install MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MiaopanCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MiaopanCode.",
  ...
  "toast.update.description": "A new version of MiaopanCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MiaopanCode team",
  ...
  "error.chain.checkConfig": "Check your config (miaopan-code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MiaopanCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MiaopanCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Customise how MiaopanCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MiaopanCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MiaopanCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MiaopanCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MiaopanCode.",
