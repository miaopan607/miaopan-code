export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.miaopanCode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.miaopanCodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Besøg ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i MiaopanCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i miaopan-code.json",
  ...
  "dialog.server.description": "Skift hvilken MiaopanCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Tjekker MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Tjekker MiaopanCode i {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Opdaterer MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Opdaterer MiaopanCode i {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Opdater MiaopanCode i {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Opdater MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før MiaopanCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter MiaopanCode igen.",
  ...
  "toast.update.description": "En ny version af MiaopanCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MiaopanCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (miaopan-code.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MiaopanCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MiaopanCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan MiaopanCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om MiaopanCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan MiaopanCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MiaopanCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MiaopanCode.",
