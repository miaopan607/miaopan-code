export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.miaopanCode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.miaopanCodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "يمنحك MiaopanCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في MiaopanCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في miaopan-code.json",
  ...
  "dialog.server.description": "تبديل خادم MiaopanCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "جارٍ التحقق من MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "جارٍ التحقق من MiaopanCode في {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "جارٍ تحديث MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "جارٍ تحديث MiaopanCode في {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "حدّث MiaopanCode في {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "تحديث MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode جاهز في {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode جاهز.",
  "wsl.onboarding.installMiaopanCodeIn": "ثبّت MiaopanCode في {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "تثبيت MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن MiaopanCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على MiaopanCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح MiaopanCode.",
  ...
  "toast.update.description": "نسخة جديدة من MiaopanCode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق MiaopanCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (miaopan-code.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن MiaopanCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن MiaopanCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم MiaopanCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ MiaopanCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور MiaopanCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان MiaopanCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة MiaopanCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل MiaopanCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من MiaopanCode.",
