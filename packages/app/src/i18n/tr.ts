...
export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.miaopanCode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.miaopanCodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "MiaopanCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MiaopanCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak MiaopanCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MiaopanCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler miaopan-code.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MiaopanCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "MiaopanCode kontrol ediliyor...",
  "wsl.onboarding.checkingMiaopanCodeIn": "{{distro}} içinde MiaopanCode kontrol ediliyor...",
  "wsl.onboarding.updatingMiaopanCode": "MiaopanCode güncelleniyor...",
  "wsl.onboarding.updatingMiaopanCodeIn": "{{distro}} içinde MiaopanCode güncelleniyor...",
  "wsl.onboarding.updateMiaopanCodeIn": "{{distro}} içindeki MiaopanCode'u güncelleyin.",
  "wsl.onboarding.updateMiaopanCode": "MiaopanCode'u güncelle",
  "wsl.onboarding.miaopanCodeReadyIn": "{{distro}} içinde MiaopanCode hazır.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode hazır.",
  "wsl.onboarding.installMiaopanCodeIn": "MiaopanCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installMiaopanCode": "MiaopanCode'u kur",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MiaopanCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından MiaopanCode'u tekrar açın.",
  ...
  "toast.update.description": "MiaopanCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MiaopanCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (miaopan-code.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: MiaopanCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MiaopanCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "MiaopanCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MiaopanCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "MiaopanCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MiaopanCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MiaopanCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MiaopanCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MiaopanCode'un en son sürümünü kullanıyorsunuz.",
