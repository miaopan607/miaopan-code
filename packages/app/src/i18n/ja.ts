export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.miaopanCode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.miaopanCodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "MiaopanCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、MiaopanCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.miaopanCodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  ...
  "provider.connect.miaopanCodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してMiaopanCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、MiaopanCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "miaopan-code.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するMiaopanCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingMiaopanCode": "MiaopanCodeを確認中...",
  "wsl.onboarding.checkingMiaopanCodeIn": "{{distro}}内のMiaopanCodeを確認中...",
  "wsl.onboarding.updatingMiaopanCode": "MiaopanCodeを更新中...",
  "wsl.onboarding.updatingMiaopanCodeIn": "{{distro}}内のMiaopanCodeを更新中...",
  "wsl.onboarding.updateMiaopanCodeIn": "{{distro}}内のMiaopanCodeを更新してください。",
  "wsl.onboarding.updateMiaopanCode": "MiaopanCodeを更新",
  "wsl.onboarding.miaopanCodeReadyIn": "{{distro}}内のMiaopanCodeの準備ができました。",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCodeの準備ができました。",
  "wsl.onboarding.installMiaopanCodeIn": "{{distro}}にMiaopanCodeをインストールしてください。",
  "wsl.onboarding.installMiaopanCode": "MiaopanCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MiaopanCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、MiaopanCodeをもう一度開いてください。",
  ...
  "toast.update.description": "MiaopanCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをMiaopanCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (miaopan-code.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MiaopanCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でMiaopanCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "MiaopanCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのMiaopanCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "MiaopanCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "MiaopanCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "MiaopanCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "MiaopanCode は最新バージョンです。",
