export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.miaopanCode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.miaopanCodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у MiaopanCode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в miaopan-code.json",
  ...
  "dialog.server.description": "Перемкніть сервер MiaopanCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Перевірка MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Перевірка MiaopanCode у {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Оновлення MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Оновлення MiaopanCode у {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Оновіть MiaopanCode у {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Оновити MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode готовий до роботи.",
  "wsl.onboarding.installMiaopanCodeIn": "Встановіть MiaopanCode у {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Встановити MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в MiaopanCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте MiaopanCode.",
  ...
  "toast.update.description": "Нова версія MiaopanCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді MiaopanCode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (miaopan-code.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, MiaopanCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер MiaopanCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд MiaopanCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи MiaopanCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему MiaopanCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску MiaopanCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію MiaopanCode.",
