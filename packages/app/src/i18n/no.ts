...
export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.miaopanCode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.miaopanCodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Besøk ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MiaopanCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i miaopan-code.json",
  ...
  "dialog.server.description": "Bytt hvilken MiaopanCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MiaopanCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MiaopanCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (miaopan-code.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MiaopanCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MiaopanCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MiaopanCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MiaopanCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om MiaopanCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan MiaopanCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MiaopanCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MiaopanCode.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Sjekker MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Sjekker MiaopanCode i {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Oppdaterer MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Oppdaterer MiaopanCode i {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Oppdater MiaopanCode i {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Oppdater MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode er klar i {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode er klar.",
  "wsl.onboarding.installMiaopanCodeIn": "Installer MiaopanCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før MiaopanCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter MiaopanCode på nytt.",
