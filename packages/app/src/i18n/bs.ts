export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.miaopanCode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.miaopanCodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MiaopanCode-u.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Posjeti ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MiaopanCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MiaopanCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u miaopan-code.json",
  ...
  "dialog.server.description": "Promijeni na koji se MiaopanCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Provjera MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Provjera MiaopanCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Ažuriranje MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Ažuriranje MiaopanCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Ažuriraj MiaopanCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Ažuriraj MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode je spreman.",
  "wsl.onboarding.installMiaopanCodeIn": "Instaliraj MiaopanCode u distribuciji {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Instaliraj MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi MiaopanCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori MiaopanCode.",
  ...
  "toast.update.description": "Nova verzija MiaopanCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MiaopanCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (miaopan-code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MiaopanCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MiaopanCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MiaopanCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako MiaopanCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MiaopanCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MiaopanCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MiaopanCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MiaopanCode-a.",
