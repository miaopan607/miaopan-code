...
export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "使用 MiaopanCode Zen 或 API 密钥连接",
  "dialog.provider.miaopanCode.tagline": "可靠的优化模型",
  "dialog.provider.miaopanCodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "MiaopanCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 MiaopanCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.miaopanCodeZen.line1": "MiaopanCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.miaopanCodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.miaopanCodeZen.visit.prefix": "访问 ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 MiaopanCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 MiaopanCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 miaopan-code.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 MiaopanCode 服务器。",
  ...
  "wsl.onboarding.checkingMiaopanCode": "正在检查 MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "正在检查 {{distro}} 中的 MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCode": "正在更新 MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "正在更新 {{distro}} 中的 MiaopanCode...",
  "wsl.onboarding.updateMiaopanCodeIn": "更新 {{distro}} 中的 MiaopanCode。",
  "wsl.onboarding.updateMiaopanCode": "更新 MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "{{distro}} 中的 MiaopanCode 已就绪。",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode 已就绪。",
  "wsl.onboarding.installMiaopanCodeIn": "在 {{distro}} 中安装 MiaopanCode。",
  "wsl.onboarding.installMiaopanCode": "安装 MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "未安装 MiaopanCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "MiaopanCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 MiaopanCode。",
  ...
  "toast.update.description": "MiaopanCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 MiaopanCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (miaopan-code.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: MiaopanCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "MiaopanCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 MiaopanCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 MiaopanCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 MiaopanCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 MiaopanCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 MiaopanCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 MiaopanCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 MiaopanCode。",
