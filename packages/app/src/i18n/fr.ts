export const dict = {
  ...
  "dialog.provider.miaopanCode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.miaopanCode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.miaopanCodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par MiaopanCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MiaopanCode.",
  ...
  "provider.connect.miaopanCodeZen.line1":
    "MiaopanCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.miaopanCodeZen.visit.prefix": "Visitez ",
  "provider.connect.miaopanCodeZen.visit.link": "github.com/miaopan607/miaopan-code/zen",
  "provider.connect.miaopanCodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MiaopanCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MiaopanCode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans miaopan-code.json",
  ...
  "dialog.server.description": "Changez le serveur MiaopanCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingMiaopanCode": "Vérification d'MiaopanCode...",
  "wsl.onboarding.checkingMiaopanCodeIn": "Vérification d'MiaopanCode dans {{distro}}...",
  "wsl.onboarding.updatingMiaopanCode": "Mise à jour d'MiaopanCode...",
  "wsl.onboarding.updatingMiaopanCodeIn": "Mise à jour d'MiaopanCode dans {{distro}}...",
  "wsl.onboarding.updateMiaopanCodeIn": "Mettez à jour MiaopanCode dans {{distro}}.",
  "wsl.onboarding.updateMiaopanCode": "Mettre à jour MiaopanCode",
  "wsl.onboarding.miaopanCodeReadyIn": "MiaopanCode est prêt dans {{distro}}.",
  "wsl.onboarding.miaopanCodeReady": "MiaopanCode est prêt.",
  "wsl.onboarding.installMiaopanCodeIn": "Installez MiaopanCode dans {{distro}}.",
  "wsl.onboarding.installMiaopanCode": "Installer MiaopanCode",
  ...
  "wsl.onboarding.distroStatus.miaopanCodeMissing": "MiaopanCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'MiaopanCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "MiaopanCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez MiaopanCode.",
  ...
  "toast.update.description":
    "Une nouvelle version d'MiaopanCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MiaopanCode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (miaopan-code.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MiaopanCode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "MiaopanCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MiaopanCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MiaopanCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MiaopanCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MiaopanCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MiaopanCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MiaopanCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MiaopanCode.",
