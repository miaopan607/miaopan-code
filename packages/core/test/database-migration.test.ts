...
import { EffectDrizzleSqlite } from "@miaopan-code/effect-drizzle-sqlite"
import { Effect, Layer } from "effect"
import { eq, inArray, sql } from "drizzle-orm"
import { DatabaseMigration } from "@miaopan-code/core/database/migration"
import { migrations } from "@miaopan-code/core/database/migration.gen"
import sessionUsageMigration from "@miaopan-code/core/database/migration/20260510033149_session_usage"
import normalizeStoragePathsMigration from "@miaopan-code/core/database/migration/20260601010001_normalize_storage_paths"
import sessionMessageProjectionOrderMigration from "@miaopan-code/core/database/migration/20260603040000_session_message_projection_order"
import eventSourcedSessionInputMigration from "@miaopan-code/core/database/migration/20260604172448_event_sourced_session_input"
import contextEpochAgentMigration from "@miaopan-code/core/database/migration/20260605042240_add_context_epoch_agent"
import simplifyIntegrationCredentialsMigration from "@miaopan-code/core/database/migration/20260611192811_lush_chimera"
import simplifySessionInputMigration from "@miaopan-code/core/database/migration/20260622202450_simplify_session_input"
...
import { SessionSchema } from "@miaopan-code/core/session/schema"
import { SessionTable } from "@miaopan-code/core/session/sql"
import sessionMetadataMigration from "@miaopan-code/core/database/migration/20260511173437_session-metadata"
...
describe("DatabaseMigration", () => {
  ...
  test("rejects a non-empty database without a session table", async () => {
    ...
    ).rejects.toThrow("数据库不为空，但不存在 session 表")
  })
