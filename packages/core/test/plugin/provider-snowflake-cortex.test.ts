...
import { SnowflakeCortexPlugin, cortexFetch } from "@miaopan-code/core/plugin/provider/snowflake-cortex"
import { ProviderPlugins } from "@miaopan-code/core/plugin/provider"
