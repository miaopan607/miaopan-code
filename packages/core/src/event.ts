...
import type { Data, Definition, Payload } from "@miaopan-code/schema/event"
...
import { Durable } from "@miaopan-code/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@miaopan-code/schema/event").ID
export type { Data, Definition, Payload } from "@miaopan-code/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/Event") {}
