...
import { type Model } from "@miaopan-code/llm"
import * as AnthropicMessages from "@miaopan-code/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@miaopan-code/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@miaopan-code/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@miaopan-code/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/v2/SessionRunnerModel") {}
