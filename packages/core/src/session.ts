...
import { ListAnchor } from "@miaopan-code/schema/session"
...
import { SessionDurable } from "@miaopan-code/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/v2/Session") {}
