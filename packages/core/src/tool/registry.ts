...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@miaopan-code/llm"
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/v2/ToolRegistry") {}
