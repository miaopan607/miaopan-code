...
export function DialogSessionList() {
    ...
    const warp = async (selection: WorkspaceSelection) => {
      const workspaceID = await (async () => {
        ...
        try {
          ...
          toast.show({
            title: t(Locale.language(), "workspace.create_failed"),
      ...
      <DialogSessionDeleteFailed
        ...
        onDelete={async () => {
          ...
          if (result.error) {
            toast.show({
              variant: "error",
              title: t(Locale.language(), "workspace.delete_failed"),
  ...
  const quickSwitchFooterHints = createMemo(() => {
    ...
    return hint && local.session.slots().length > 0
      ? [{ title: t(Locale.language(), "dialog.switch"), label: hint }]
      : []
  })
  ...
  const options = createMemo(() => {
    ...
    function buildOption(id: string, category: string) {
      ...
      const gutter = isWorking
        ...
        : slot !== undefined
          ...
          : undefined
      return {
        title: isDeleting ? t(Locale.language(), "dialog.confirm_delete_short", { key: deleteHint() }) : x.title,
    ...
    const remaining = displayOrder
      ...
      .map((id) => {
        ...
        return buildOption(id, label === today ? t(Locale.language(), "dialog.today") : label)
      })
      .filter((x) => x !== undefined)

    return [
      ...pinned.map((id) => buildOption(id, t(Locale.language(), "dialog.pinned"))).filter((x) => x !== undefined),
      ...remaining,
    ]
  })
  ...
  return (
    <DialogSelect
      title={t(Locale.language(), "dialog.sessions")}
      options={options()}
      skipFilter={true}
      ...
      actions={[
        {
          ...
          title: t(Locale.language(), "dialog.pin_unpin"),
        ...
        },
        {
          ...
          title: t(Locale.language(), "dialog.delete"),
              ...
              try {
                ...
                if (result.error) {
                  if (session?.workspaceID) {
                    ...
                    toast.show({
                      variant: "error",
                      title: t(Locale.language(), "session.delete_failed_title"),
                      message: errorMessage(result.error),
                    })
                  }
                  setToDelete(undefined)
        ...
        },
        {
          ...
          title: t(Locale.language(), "dialog.rename"),
          onTrigger: async (option) => {
...
function quickSwitchRange(first: string, last: string) {
  ...
  return t(Locale.language(), "tui.range_through", { first, last })
}
