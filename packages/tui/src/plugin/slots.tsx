import type { TuiPluginApi, TuiSlotContext, TuiSlotMap, TuiSlotProps } from "@miaopan-code/plugin/tui"
  ...
  return {
    ...
    setup(api: HostPluginApi): HostSlots {
      const registry = createSolidSlotRegistry<RuntimeSlotMap, TuiSlotContext>(
        ...
        {
          onPluginError(event) {
            console.error(`[tui.slot] ${t(Locale.language(), "tui.error.plugin_error")}`, {
