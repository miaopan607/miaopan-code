...
export const Definitions = {
  ...
  command_palette_favorite_toggle: keybind("ctrl+f", "i18n:keybind.command_palette_favorite_toggle"),
  command_palette_favorite_move_up: keybind("[", "i18n:keybind.command_palette_favorite_move_up"),
  command_palette_favorite_move_down: keybind("]", "i18n:keybind.command_palette_favorite_move_down"),
  ...
  model_favorite_move_up: keybind("[", "i18n:keybind.model_favorite_move_up"),
  model_favorite_move_down: keybind("]", "i18n:keybind.model_favorite_move_down"),
  model_list: keybind("<leader>m", "i18n:tui.switch_model"),
  model_refresh: keybind("ctrl+r", "i18n:cli.run.models_refresh"),
...
export const CommandMap = {
  ...
  command_palette_favorite_toggle: "command.palette.favorite",
  command_palette_favorite_move_up: "command.palette.favorite_up",
  command_palette_favorite_move_down: "command.palette.favorite_down",
  help_show: "help.show",
  docs_open: "docs.open",
  diff_open: "diff.open",
  ...
  model_favorite_move_up: "model.dialog.favorite_up",
  model_favorite_move_down: "model.dialog.favorite_down",
