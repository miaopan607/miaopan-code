import { MiaopanCode } from "@miaopan-code/client/effect"
...
import { createEmbeddedRoutes } from "@miaopan-code/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("MiaopanCode.create")(function* () {
  ...
  const client = yield* MiaopanCode.make({ baseUrl: "http://miaopanCode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@miaopan-code/sdk-next/MiaopanCode") {}
