export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの MiaopanCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "MiaopanCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'miaopan-code' コマンドを使用してください。",
