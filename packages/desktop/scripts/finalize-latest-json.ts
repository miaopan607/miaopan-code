...
const releaseId = process.env.MIAOPAN_CODE_RELEASE
if (!releaseId) throw new Error("MIAOPAN_CODE_RELEASE is required")

const version = process.env.MIAOPAN_CODE_VERSION
if (!version) throw new Error("MIAOPAN_CODE_VERSION is required")
...
const macxTarGz = "miaopanCode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "miaopanCode-desktop-mac-arm64.app.tar.gz"
