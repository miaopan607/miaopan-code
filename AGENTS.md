...
Valid types are `feat`, `fix`, `docs`, `chore`, `refactor`, and `test`. Scopes are optional; use the affected package or area when helpful, e.g. `core`, `miaopan-code`, `tui`, `app`, `desktop`, `sdk`, or `plugin`.
