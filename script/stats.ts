...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/miaopan607/miaopan-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for miaopan607/miaopan-code...\n")
...
console.log("Fetching npm all-time downloads for miaopan-code-ai...\n")
const npmDownloads = await fetchNpmDownloads("miaopan-code-ai")
